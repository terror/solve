...
const getCodeforcesProblem = ({ contest, problem, }) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    try {
        ...
        for (let i = 0; i < samples.length; i += 2) {
            const input = (_a = samples
                .eq(i)
                .find('pre')
                .html()) === null || _a === void 0 ? void 0 : _a.replace(/<br>/g, '\n').replace(/&#xA0;/g, '\xa0');
            const output = (_b = samples
                .eq(i + 1)
                .find('pre')
                .html()) === null || _b === void 0 ? void 0 : _b.replace(/<br>/g, '\n').replace(/&#xA0;/g, '\xa0');
